...
const TREE = {
  ...
  sv_creadores: {
    message: "VocaBot fue desarrollado durante el año 2026 por estudiantes de 5° Año del Instituto San José, en el marco de los espacios curriculares 'Formación para la Vida y el Trabajo' y 'Metodología de la Investigación en Ciencias Sociales', con el acompañamiento de sus docentes.\n\nEl chatbot busca convertirse en una herramienta de orientación para acompañar la construcción de decisiones sobre el futuro académico, laboral y personal.",
  ...
  in_oferta: {
    message: "Laboulaye se está constituyendo paulatinamente como uno de los polos educativos más importantes de la región.\n\nAquí podrás encontrar toda la información sobre carreras e instituciones disponibles en la ciudad.",
  ...
  iv_problema: {
    message: "¿Cómo influye el uso de la inteligencia artificial en los proyectos de vida de los/as estudiantes del último año de la escuela secundaria de la localidad, y cuáles son las motivaciones para su utilización?",
  ...
  iv_metodologia: {
    message: "Enfoque metodológico mixto, articulando procedimientos cuantitativos y cualitativos. El estudio se inscribe en el paradigma sociocrítico y asume características de la investigación-acción.\n\nLa recolección de datos se realizó mediante encuestas (Formularios de Google) y entrevistas en profundidad a profesionales de la ciudad.",
